...
import { buildSubject, generateFollowupEmailBody } from "@/server/services/followup-email-generator";
...
export async function runEligibleFollowups(): Promise<FollowupRunResult> {
